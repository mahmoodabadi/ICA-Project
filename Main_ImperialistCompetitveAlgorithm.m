...
ProblemParams.CostFuncName ='Hepatit';% 'BenchmarkFunction2clevhung'  %'Alldatasets';   %'BenchmarkFunction2';         %'Alldatasets';    %'BenchmarkFunction2'; %'Benchmark2hungarian'; %  'BenchmarkFunction2';
...
ProblemParams.NPar = 78;                          % Number of optimization variables of your objective function. "NPar" is the dimention of the optimization problem.
ProblemParams.VarMin = [0] ;                         % Lower limit of the optimization parameters. You can state the limit in two ways. 1)   2)
