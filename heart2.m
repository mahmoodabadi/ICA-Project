...
load 'C:\Users\Zahra\Desktop\hungarian.mat';

%  t = classregtree([g2,g4,g7,g9,g10,g11,g12,g13],class1);
t=classregtree([g1,g2,g3,g4,g5,g6,g7,g8,g9,g10,g11,g12,g13],class1);
t2=prune(t,'level',3);
view(t2);
n=[g1,g2,g3,g4,g5,g6,g7,g8,g9,g10,g11,g12,g13];
% n=[g2,g4,g7,g9,g10,g11,g12,g13];
x=eval(t2,n)
k1=0;
v=cellstr(class1);
for i=1:length(x)
...
0 0 3 3 1 2 0 0 3 1 1
0 0 3 3 1 2 1 0 1 1 1
0 0 3 3 1 2 2 0 4 1 1
0 1 3 0 2 0 0 1 4 1 1
0 1 3 2 3 0 0 2 2 1 1
0 1 3 3 3 0 0 2 3 1 1
0 1 3 0 3 0 0 2 2 1 1
0 1 3 0 4 0 0 2 5 1 1
2 2 3 0 2 0 0 0 3 1 1
3 2 3 0 2 0 0 0 4 1 1
];
